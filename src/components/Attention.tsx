...
const Attention = () => {
  return (
    <div className="bg-gradient-to-r from-green-50 via-green-100 to-green-50 py-15 px-5 flex flex-col justify-center items-center border-y-2 border-green-300 mb-10">
        <h2 className="text-5xl font-extrabold my-5">Você está <span className="text-red-700">perdendo dinheiro</span> agora mesmo</h2>
